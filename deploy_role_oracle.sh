...
if [ $answer == "YES" ]||[ $answer == "y" ]||[ $answer == "yes" ];then
    ...
    echo "#######################################################"
    echo 'export JAVA_HOME=/usr/java/jdk1.7.0_79' >> ~/.bash_profile;
    echo 'export PATH=$PATH:$JAVA_HOME/bin:$JAVA_HOME/jre/bin' >> ~/.bash_profile;
    ...
    echo 'export LD_LIBRARY_PATH=$ORACLE_HOME/lib:/lib64:/usr/lib:/usr/lib64:/usr/local/lib64' >> /home/oracle/.bash_profile;
    echo 'export CLASSPATH=$ORACLE_HOME/JRE:$ORACLE_HOME/jlib:$ORACLE_HOME/rdbms/jlib' >> /home/oracle/.bash_profile;
    echo 'export LD_ASSUME_KERNEL=2.6.18' >> /home/oracle/.bash_profile;
    echo 'export NLS_LANG="american_america.UTF8"' >> /home/oracle/.bash_profile;
    echo 'export NLS_LANG="AMERICAN_AMERICA.US7ASCII"' >> /home/oracle/.bash_profile;
